...
export const Search = ({navigation}) => {
  ...
  const submit = async () => {
    ...
    try{await ky.post(process.env.REACT_APP_AUDIO, {body: fd}); setIsLoading(false); navigation.navigate('Analyze', {searchVal: value, lang: lang, prev: -1, prevHolder: []});}
    ...
    <>
      ...
      <ApplicationProvider {...eva} theme = {eva.dark}>
        <Layout style={styles.container}>
          <Layout>
            <Text style={{color: '#f7faff', textAlign: 'center'}} category='h1'>Language Assessment</Text>
